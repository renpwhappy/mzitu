...
# 将所有文件夹名转换为str类型
folder_name = " ".join(os.listdir(r"/Users/renpeiwei/Pictures/mzitu"))
...
# 解析成 json 类型并写入文件
words = json.dumps(counter_sort, ensure_ascii=False).encode("utf-8")
with open(r"./data/words.json", "w+") as f:
    f.write(words)
